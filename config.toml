...
baseURL = "https://frattagliafumante.com/"
languageCode = "en-en"
defaultContentLanguage = "it-it"
title = "Frattaglia Fumante Blog"
theme = "hugo-tranquilpeak-theme"
disqusShortname = "frattagliafumante"
enableEmoji = true
googleAnalytics = "UA-111350772-1"
paginate = 12
canonifyurls = true
...
[author]
  ...
  bio = "Professore, Fumettista, Blogger e Papà. <br> Ugualmente **scarso** in tutte e quattro le attività. <br><br> *Contattami:* <br> <marco.miroballo@gmail.com>"
  job = "<sup>**Art Teacher***@Carlo Pepoli middle school*</sup>"
  location = "Bologna, Italy"
  # Your Gravatar email. Overwrite `author.picture` everywhere in the blog
  gravatarEmail = "marco.miroballo@gmail.com"
...
[[menu.main]]
  ...
  [[menu.links]]
    ...
    url = "https://www.instagram.com/frattagliafumante/"
  [[menu.links]]
    weight = 2
    identifier = "Facebook"
    name = "Facebook"
    pre = "<i class=\"sidebar-button-icon fa fa-lg fa-facebook\"></i>"
    url = "https://www.facebook.com/frattagliafumante/"
  [[menu.links]]
    weight = 3
    identifier = "Linkedin"
    name = "Linkedin"
    pre = "<i class=\"sidebar-button-icon fa fa-lg fa-linkedin\"></i>"
    url = "https://www.linkedin.com/in/marco-miroballo/"
  # [[menu.links]]
  #  weight = 4
  #  identifier = "Personal"
  #  name = "Sito Personale"
  #  pre = "<i class=\"sidebar-button-icon fa fa-lg fa-at\"></i>"
  #  url = "http://marcomiroballo.netlify.com/"


  [[menu.misc]]
    weight = 2
    identifier = "Ringraziamenti"
    name = "credits"
    pre = "<i class=\"sidebar-button-icon fa fa-lg fa-heart\"></i>"
    url = "/ringraziamenti"
  [[menu.misc]]
    weight = 1
    identifier = "rss"
...
[params]
  ...
  description = "Blog di Frattaglia Fumante"
  ...
  coverImage = "https://res.cloudinary.com/frattaglia/image/upload/v1574764241/cover_epbgio.jpg"
